...
d_na_fill$weekday = factor(days)
avg_stp_wk_int = aggregate(d_na_fill$steps, by = list(d_na_fill$interval,d_na_fill$weekday), mean)
colnames(avg_stp_wk_int) = c('interval','weekday','steps')
plot(avg_stp_wk_int$interval[avg_stp_wk_int$weekday == 'Weekday'],
     avg_stp_wk_int$steps[avg_stp_wk_int$weekday == 'Weekday'],col  ='blue',xlab = 'Interval',ylab = 'Steps')
